...
## Usage
### MuJoCo Sim2Sim Extension

The original RoboDuet IsaacGym code is kept in the main project layout. The IsaacGym-to-MuJoCo sim2sim extension is organized separately under:

```text
sim2sim_mujoco/
```

The current Go1 + ARX MuJoCo sim2sim workflow, controls, scripted replay, and validation commands are documented in `sim2sim_mujoco/docs/mujoco_sim2sim.md`.
